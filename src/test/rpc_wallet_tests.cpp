...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CFreecoinAddress demoAddress = CFreecoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CFreecoinAddress setaccountDemoAddress = CFreecoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CFreecoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFreecoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
