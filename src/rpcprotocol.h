...
#ifndef FREECOIN_RPCPROTOCOL_H
#define FREECOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Freecoin is not connected
