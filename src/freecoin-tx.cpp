...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Freecoin Core freecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  freecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded freecoin transaction") + "\n" +
              "  freecoin-tx [options] -create [commands]   " + _("Create hex-encoded freecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded freecoin transaction
