...
#ifndef FREECOIN_QT_FREECOINUNITS_H
#define FREECOIN_QT_FREECOINUNITS_H
...
/** Freecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FreecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FreecoinUnits(QObject *parent);

    /** Freecoin units.
      @note Source: https://en.freecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef FreecoinUnits::Unit FreecoinUnit;

#endif // FREECOIN_QT_FREECOINUNITS_H
