...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/freecoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Freecoin Core"),
     ...
     * override -datadir in the freecoin.conf file in the default data directory
     * (to be consistent with freecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
