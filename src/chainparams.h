...
#ifndef FREECOIN_CHAINPARAMS_H
#define FREECOIN_CHAINPARAMS_H
 ...
 * Freecoin system. There are three: the main network on which people trade goods
...
public:
    ...
    /** Used if GenerateFreecoins is called with a negative number of threads */
