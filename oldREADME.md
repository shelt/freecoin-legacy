...
| Content  | Offending transaction or block's hash (if applicable) |
...
## Block storage
Blocks are stored as files and grouped into multiples of 2016. 2016 is chosen to be concurrent with target recalculation. 
